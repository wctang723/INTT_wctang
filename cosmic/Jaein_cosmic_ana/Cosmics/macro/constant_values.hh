...
const string kIntt_data_dir	= "/sphenix/u/wctang/workspace/my_INTT/INTT_detect_efficiency_cosmic/DST_files/data/";
...
const string kIntt_qa_dir	= "/sphenix/u/wctang/workspace/my_INTT/INTT_detect_efficiency_cosmic/DST_files/QA/";
