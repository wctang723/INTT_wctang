...
int Fun4All_CosmicAnalysis(int run_num = 39468, int nEvents = 10000,
			   const int skip = 0) {
    ...
    */
	...
	new AnalysisInttCosmicCommissioning("AnalysisInttCosmicCommissioning",
					    output_name);
