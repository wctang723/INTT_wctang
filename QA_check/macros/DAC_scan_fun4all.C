...
const string &inputdir = "/direct/sphenix+tg+tg01/commissioning/INTT/work/weiche/my_INTT/QA_check/DST_files/DAC0_scan/";
int DAC_scan_fun4all (
	int nEvents = 0,
    const string &inputfilename = "DST_beam_intt-00041577_no_hot_special.root",
